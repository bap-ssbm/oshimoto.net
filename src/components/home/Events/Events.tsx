  ...
  return (
    <div className="flex flex-col md:flex-row gap-16 md:gap-20">
      ...
      <div className="md:w-[45%]">
        <p className="font-anonymous-pro text-[10px] tracking-[0.25em] uppercase text-gold/50 mb-6">
          Latest
        </p>
        <a
        ...
        >
          ...
          <p className="text-warm-gray/60 text-[11px] tracking-[0.15em] font-anonymous-pro mb-3">
            {featured.date}
          </p>
          ...
          <p className="text-warm-gray/50 text-[13px]">{featured.place}</p>
        </a>
      </div>
      ...
      <div className="md:w-[55%] md:pt-10">
        ...
        <div className="relative">
          ...
          <div className="absolute left-[3px] top-2 bottom-2 w-px bg-warm-gray/10 hidden md:block" />
          ...
          {past.map((evt, i) => (
            <div key={i} className="group relative flex gap-6 md:gap-8 mb-10 last:mb-0">
              ...
              <div className="hidden md:flex flex-col items-center pt-1.5 flex-shrink-0">
                <div className="w-[7px] h-[7px] rounded-full border border-warm-gray/20 group-hover:border-gold/50 group-hover:bg-gold/20 transition-all duration-500" />
              </div>
              ...
              <div className="flex-1 pt-0.5">
                <p className="text-warm-gray/50 text-[11px] tracking-[0.12em] font-anonymous-pro mb-1.5">
                  {evt.date}
                </p>
