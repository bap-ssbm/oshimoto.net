...
export default function SideMenu({ setShowSide }: SideMenuProps) {
  ...
  return (
    <div
      ref={menuRef}
      style={{ opacity: 0 }}
      className="md:hidden bg-black-950 py-36 min-h-[100svh] box-border w-screen absolute top-0 left-0 z-[30] px-[5%] flex flex-col items-end gap-10"
    >
      <nav className="flex flex-col text-[20px] gap-5 tracking-[4px] font-[300] text-cream text-end" aria-label="Mobile navigation">
